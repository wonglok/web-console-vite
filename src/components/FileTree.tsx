...
export function FileTree() {
  ...
  // Right-click on empty area: create at root level, no rename/delete target
  ...
  return (
    ...
    >
      ...
      {tree.length > 0 && <div className="flex-1" style={{ minHeight: 16 }} />}
      {modal && (
        <CreateModal
          type={modal.type}
      ...
      {emptyContextMenu && (
        <ContextMenu
          ...
          onNewFile={() => {
            setModal({ type: "file", parentDir: "/" });
            setEmptyContextMenu(null);
          }}
          onNewFolder={() => {
            setModal({ type: "folder", parentDir: "/" });
            setEmptyContextMenu(null);
          }}
